...
class ImageViewer extends React.Component<ImageViewerProps, any>{
    ...
    render() {
        ...
        const property: string = properties.find((x: { url: string }) => x.url === "https://i.picsum.photos/id/158/4836/3224.jpg?hmac=Gu_3j3HxZgR74iw1sV0wcwlnSZSeCi7zDWLcjblOp_c").url
