...
class GalleryCollectionCard extends React.Component<GalleryCollectionCardTextProps> {
    render() {
        ...
        return (
            <div
                data-testid="Gallery-Collection-Card-Text"
                className={classes.container}>
                <div
                    data-testid="Gallery-Collection-Card-Tag"
                    className={classes.tag}
                    style={{borderBottomColor: this.props.colour}}>
                    {this.props.tagTitle?.toUpperCase()}
                </div>
                <div
                    data-testid="Gallery-Collection-Card-Content-Text"
                    className={classes.text}>
                    {this.props.text}
                    <GalleryCollectionCardItemsText
                        items={this.props.itemNumber}
                    />
                </div>
