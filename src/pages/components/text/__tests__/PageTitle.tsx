...
describe('Page Title', () => {
    ...
    it('should render correctly post-load', () => {
        ...
        const { getByTestId } = render(<PageTitle title="test-title" skipLoad={true} />)
    ...
    it('should render signature when specified', () => {
        ...
        const { getByTestId } = render(<PageTitle title="test-title" signature={true} />)
        expect(getByTestId('PageTitle-Signature')).toHaveAttribute("src", "Logo.png")
